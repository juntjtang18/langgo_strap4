...
module.exports = ({ strapi }) => ({
  ...
  async getTodaySnapshot(userid, date = new Date()) {
    ...
    const rows = await strapi.entityService.findMany('plugin::rank-system.rs-user-snapshot', {
  ...
  async ensureTodaySnapshot(userid, username, date = new Date()) {
    ...
    return strapi.entityService.create('plugin::rank-system.rs-user-snapshot', {
      data: {
  ...
  async updateSnapshot(snapshotId, data) {
    return strapi.entityService.update('plugin::rank-system.rs-user-snapshot', snapshotId, { data });
  },
